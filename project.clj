(defproject cljs-dep-test "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "cljs-dep-test.core/on-js-reload"
                ...
                :compiler {:main cljs-dep-test.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/cljs_dep_test.js"
